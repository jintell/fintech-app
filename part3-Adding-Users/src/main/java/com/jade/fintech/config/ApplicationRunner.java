...
public class ApplicationRunner implements CommandLineRunner {
    ...
    private List<Transaction> getTransactions() {
        ...
        new Transaction(4L, TRANSACTION_TYPE.TRANSFER, Instant.now(), 1234, "USD",
                        new BigDecimal("200.00"), "Contoso", "NA" ),
                new Transaction(5L, TRANSACTION_TYPE.CARD, Instant.now(), 1234567, "USD",
                        new BigDecimal("200.00"), "Morley", "NA" ),
                new Transaction(6L, TRANSACTION_TYPE.TRANSFER, Instant.now(), 1234567, "USD",
                        new BigDecimal("200.00"), "Contoso", "NA" ));
    }
}
