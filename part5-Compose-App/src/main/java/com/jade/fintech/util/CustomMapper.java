...
public class CustomMapper {
    ...
    public static TransactionDto convertToTransactionDto(Transaction transaction){
        ...
        transactionDto.setStringTransactionDate();
    ...
    public static Transaction convertToTransaction(TransactionDto transactionDto){
        ...
        transaction.setType(TRANSACTION_TYPE.valueOf(getTransactionType(transactionDto.getType())));
    ...
    private static String getTransactionType(String transType) {
        return transType == null? TRANSACTION_TYPE.DEBIT.name(): transType.toUpperCase();
    }
}
