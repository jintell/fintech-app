...
public class TransactionServiceMocWebServerTest {
    ...
    @Test
    void getTransactionByAccountIDTest() throws Exception, TransactionsNotFoundException {
    ...
    private RESTTransactionsAPIClient getAPIClient() {
        return new RESTTransactionsAPIClient(WebClient.create(), new AccessTokenService(WebClient.create()));
    }
